...
def _collect_metric_files(root: Path) -> list[Path]:
    cands = [
        ...
        root / "hydro_l2" / "metrics_summary_val.json",
        root / "hydro_l2" / "metrics_summary_test.json",
        root / "hydro_l2" / "metrics_summary.json",
        root / "hydro_l1" / "metrics_summary_val.json",
        root / "hydro_l1" / "metrics_summary_test.json",
        root / "hydro_l1" / "metrics_summary.json",
        root / "hydro_l0" / "metrics_summary_val.json",
        root / "hydro_l0" / "metrics_summary_test.json",
        root / "hydro_l0" / "metrics_summary.json",
