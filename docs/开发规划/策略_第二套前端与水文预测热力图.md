...
> **决策日期**：以仓库内文档更新为准。  
> **适用范围**：与 `docs/开发规划/规划_实时系统与离线系统详细设计.md` **同一套离线/实时同屏产品**（左涡旋、右上水文、右下风浪）下的 **Vite SPA**；**不改变** `src/` 评测脚本、`run_eval_all.sh` 及 `相关文件/AI_DEV_REQUIREMENTS.md` 中的不可更改项。  
> **配套文档**：`docs/工程手册/开发文档_新前端离线系统与实时系统.md`（工程落地）、`docs/开发规划/规划_实时系统与离线系统详细设计.md`（产品目标态全文）。
...
- [x] `docs/开发规划/策略_第二套前端与水文预测热力图.md`（本文）  
- [x] `docs/工程手册/开发文档_新前端离线系统与实时系统.md`  
- [x] `docs/开发规划/规划_实时系统与离线系统详细设计.md`  
