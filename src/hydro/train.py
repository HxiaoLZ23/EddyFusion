...
def main() -> None:
    ...
    val_loader = DataLoader(val_ds, batch_size=batch_size, shuffle=False, num_workers=loader_kw["num_workers"])
    ...
    for ep in range(1, epochs + 1):
        tr_loss = train_epoch(model, train_loader, device, optimizer, scaler, grad_clip)
